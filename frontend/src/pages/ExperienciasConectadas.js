...
export default function ExperienciasConectadas() {
  ...
  return (
    <div style={{ maxWidth:600, margin:'0 auto', padding:'0 16px 80px', minHeight:'100vh', background:'#0e0e1a', color:'#e2e8f0' }}>
      <div style={{ display:'flex', alignItems:'center', gap:14, padding:'20px 0 20px', borderBottom:'1px solid rgba(255,255,255,0.07)' }}>
        ...
        <h2 style={{ margin:0, fontSize:19, fontWeight:800 }}>Experiencias conectadas</h2>
      </div>
      <div style={{ textAlign:'center', padding:'80px 20px' }}>
        <div style={{ fontSize:56, marginBottom:16 }}>🔗</div>
        <div style={{ fontSize:18, fontWeight:700, marginBottom:10 }}>Experiencias conectadas</div>
        <div style={{ fontSize:14, color:'#475569', lineHeight:1.7 }}>Gestiona las aplicaciones y sitios web que tienes conectados a tu cuenta de NOX.</div>
